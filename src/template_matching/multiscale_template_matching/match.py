...
base_path = "C:\\Users\\kouse\\Desktop\\ImageProcessing\\PyImageSearchPlus\\20150126_multiscale-template-matching"


# -----------------------------------------------------------------------------------------------
# load template image and preprocess
# -----------------------------------------------------------------------------------------------

tmplt = os.path.join(base_path, 'cod_logo.png')
...
for imagePath in glob.glob(os.path.join(base_path, 'images') + "/*.jpg"):
